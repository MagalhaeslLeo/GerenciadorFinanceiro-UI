...
@Component({
  selector: 'tabelaCrudInput',
  templateUrl: './tabelaCrudInput.component.html',
  styleUrls: ['./tabelaCrudInput.component.scss']
})
export class TabelaCrudInputComponent implements OnInit {
