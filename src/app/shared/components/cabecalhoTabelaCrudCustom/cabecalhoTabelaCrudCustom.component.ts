...
@Component({
    selector: 'cabecalhoTabelaCrudCustom',
    templateUrl: './cabecalhoTabelaCrudCustom.component.html',
    styleUrls: ['./cabecalhoTabelaCrudCustom.component.scss']
})
export class CabecalhoTabelaCrudCustomComponent {
    constructor() { }
